---
name: user
description: "Who Justin is — identity, how he thinks, technical level, work style. Personal context (Katie, family, social dynamics) lives in private repo."
metadata: 
  node_type: memory
  type: user
...
## Personal Context → Moved to Private Repo

*Moved 2026-06-02. Destination: `/home/zenko/.claude/personal-context/user.md` (private repo: `kyotodesertfox/justin-personal-context`)*

*Covers: Katie Williams (relationship dynamic, deflection tactics, behavioral analysis), Geoffrey (father/HELOC/pension), Matthew (brother), sister, Buddy Greer, Keith Wright, origin/military, on using Claude.*

*Read that file when personal/social context is needed for logic-engine reasoning.*
